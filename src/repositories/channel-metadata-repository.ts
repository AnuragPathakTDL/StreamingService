  ...
  async upsert(record: ChannelMetadata): Promise<void> {
    ...
    await this.pool.query(
      `INSERT INTO stream_channels (
          content_id, channel_id, classification, manifest_path, playback_url, origin_endpoint,
          cache_key, checksum, status, retries, source_asset_uri, last_provisioned_at,
          drm_key_id, drm_license_server, ingest_region, availability_starts_at, availability_ends_at,
          geo_allow, geo_deny
        ) VALUES (
